...
//		int n = 4;
		int n = sc.nextInt();
		noOfWays=0;								// agr ye nhi kia toh test case fail hogi input 1 ke liye
		// bcaz backend se  other many test case ayegi and hmne yha pe static kia hai ans list ko
// toh purana solution v exists rhega usme isliye ek bar aur new krdo toh phle ka sab erase ho jayega
